This guide is wholly borrowed from the `Cookiecutter Django Read the Docs`.  It is copied here to be preserved as a moment in time, in case I don't update to their newest version or the steps change.

.. _`Cookiecutter Django Read the Docs`: https://cookiecutter-django.readthedocs.io/en/latest/developing-locally-docker.html
...
.. note::
    ...
    `this issue with Postgres`_).

.. _`this issue with Postgres`: https://cookiecutter-django.readthedocs.io/en/latest/troubleshooting.html#docker-postgres-auth-failed
