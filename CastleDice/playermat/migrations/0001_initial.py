    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adds_animal', models.CharField(max_length=16, choices=[(b'pig', b'pig'), (b'horse', b'horse'), (b'chicken', b'chicken'), (b'cow', b'cow'), (b'', b'')])),
            ],
        ),
        migrations.CreateModel(
            name='PlayerMat',
            fields=[
                ...
                ('player_merchant_hand', annoying.fields.JSONField(null=True, blank=True)),
